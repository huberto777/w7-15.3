...
class TimeboxList extends React.Component {
  ...
  addTimebox = timebox => {
    TimeboxesAPI.addTimebox(timebox, this.props.accessToken).then(addedTimebox =>
  ...
  updateTimebox = (indexToUpdate, timeboxToUpdate) => {
    TimeboxesAPI.replaceTimebox(timeboxToUpdate, this.props.accessToken).then(updatedTimebox =>
      this.setState(prevState => {
